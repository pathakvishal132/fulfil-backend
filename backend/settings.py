...
FRONTEND_DOMAIN = "https://fulfil-frontend.vercel.app"
...
CORS_ALLOWED_ORIGINS = [
    ...
    FRONTEND_DOMAIN,  # production frontend
]
CORS_ALLOW_CREDENTIALS = True
...
# Optional: Integrate django-cors-headers if installed
if importlib.util.find_spec("corsheaders") is not None:
    pass  # Already included in INSTALLED_APPS and middleware
